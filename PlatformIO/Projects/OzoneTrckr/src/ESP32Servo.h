...
#define MIN_PULSE_WIDTH       400     // widened SG90 range (was 500) -> filter servo reaches its low end
#define MAX_PULSE_WIDTH      2600     // widened SG90 range (was 2500) -> filter servo reaches its high end
