...
static const float V_MIN = 50,  V_MAX = 140;

// ---- rest / start position (where it begins each seek) ----
static const float START_H = 90, START_V = 140;
...
static const int   STEP_MS   = 30;     // min interval between moves (settle time -> anti-hunt)
